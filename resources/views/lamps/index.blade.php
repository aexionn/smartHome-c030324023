    ...
    function updateLamp(payload) {
        ...
        $.ajax({
            ...
            , error: function(jqXHR, textStatus, errorThrown) {
                ...
                // Kembalikan checkbox ke posisi semula karena update gagal
                let checkbox = document.getElementById(payload.id);
                ...
                // Tampilkan pesan yang lebih ramah ke pengguna
                toastr.error('Gagal mengubah status. Coba lagi.', 'ERROR!');
            }
        });
    }
